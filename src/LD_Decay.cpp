...
void More_HelpLDDecay()
{
	cout<<""
		...
		" Para [-OutType] can be [0-8] , you can try try... [ -OutType 3] is the fastest for  only cal R2 for MeanBin method plot\n"
		"\n"
...
int LDdecay_help01(int argc, char **argv , In3str1v * paraFA04, Para_18 * para_18)
{
	...
	for(int i = 1; i < argc ; i++)
	{
		...
		else if (flag == "EHH" )
		{
			...
			{
				cerr<<"\tPara [-EHH] should be [chr:Site],such [chr1:5000]\n";
				return 0;
			}
		}
